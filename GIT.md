...
This document describes the Git workflow for contributing to the web-template project.
...
1. Go to https://github.com/codesphere-dev/web-template
...
upstream  https://github.com/codesphere-dev/web-template.git (fetch)upstream  https://github.com/codesphere-dev/web-template.git (push)
```
...
3. **Important**: Ensure the base repository is `codesphere-dev/web-template` and the base branch is `develop`
...
3. **Set base repository to**: `codesphere-dev/web-template`
