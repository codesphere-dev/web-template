...
1. [Type Safety Fundamentals](#type-safety-fundamentals)
   - [Why We Ban `any`](#why-we-ban-any)
   - [When to Use `unknown`](#when-to-use-unknown)
   - [When to Use `never`](#when-to-use-never)
   - [Proper Use of `as const`](#proper-use-of-as-const)
   - [Proper Use of `satisfies`](#proper-use-of-satisfies)
2. [React-Specific Patterns](#react-specific-patterns)
   - [Component Props](#component-props)
   - [Custom Hook Typing](#custom-hook-typing)
   - [Event Handler Typing](#event-handler-typing)
3. [Advanced Patterns](#advanced-patterns)
   - [Discriminated Unions for State Management](#discriminated-unions-for-state-management)
   - [Generic Constraints and Inference](#generic-constraints-and-inference)
   - [Mapped Types and Conditional Types](#mapped-types-and-conditional-types)
   - [Type Guards and Assertion Functions](#type-guards-and-assertion-functions)
   - [Branded Types for Domain Safety](#branded-types-for-domain-safety)
4. [API Response Validation](#api-response-validation)
   - [Integration with Zod Schemas](#integration-with-zod-schemas)
   - [Type Inference from Validators](#type-inference-from-validators)
   - [Runtime Type Checking Patterns](#runtime-type-checking-patterns)
5. [Common Mistakes & Solutions](#common-mistakes--solutions)
   - [Type Assertion Abuse](#type-assertion-abuse)
   - [Over-Engineering with Generics](#over-engineering-with-generics)
   - [Missing Null/Undefined Handling](#missing-nullundefined-handling)
   - [Circular Type Dependencies](#circular-type-dependencies)
6. [Type Decision Matrix](#type-decision-matrix)
7. [ESLint Rule References](#eslint-rule-references)
   - [Recommended tsconfig.json Settings](#recommended-tsconfigjson-settings)
